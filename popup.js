let modelContanirArry={
    modelheader: {modeltitile: ['Keeping track of hundreds  of components website', 'Multi Post Stories'] ,closeModel: 'X'}, 
    modeltag: {tag1:'image/html.svg', tag2: 'image/bootstrap.svg', tag3: 'image/Ruby-on-rails.svg'  },
    modelBody: {bodyimage:'image/model-image.png', modeltext:`Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the releaLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the releax map lapora verita.`
    }
  }
  //Model Header
  ...
  // const t=document.querySelector('.cardbutton0');
