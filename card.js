const cardTitle=['Website Protfolio ','Data DashboardHealthcare', 'Profesional Art Printing Data More ', 'Website Protfolio ','Data DashboardHealthcare',''];
...
for(let i=0;i<cardTitle.length;i++){
    ...
    else{const fatch=document.querySelector('.wrapper-desktop').innerHTML;
